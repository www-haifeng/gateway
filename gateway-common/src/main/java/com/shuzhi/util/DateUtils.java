...
public class DateUtils extends org.apache.commons.lang.time.DateUtils {
	...
	public static final SimpleDateFormat formatTimestamp = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");
	 ...
	 * @param
	 */
	public static String getDate(String time,String parent){
		SimpleDateFormat sb = new SimpleDateFormat(parent);
		Date date = new Date(Long.parseLong(time));
		return sb.format(date);
	}
	
	public static Date getDateBytime(String time,String parent){
		try {
		SimpleDateFormat sb = new SimpleDateFormat(parent);
