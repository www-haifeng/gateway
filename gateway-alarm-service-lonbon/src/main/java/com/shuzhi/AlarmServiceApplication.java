...
public class AlarmServiceApplication {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ConfigurableApplicationContext context = SpringApplication.run(AlarmServiceApplication.class, args);
        //开启websocket服务端
        TCPServer tcpServer = context.getBean(TCPServer.class);tcpServer.start();
        //socketClientCreate
    }
